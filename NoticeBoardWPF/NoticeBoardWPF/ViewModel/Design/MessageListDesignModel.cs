        ...
        public MessageListDesignModel()
        {
            Items = new List<MessageListItemViewModel>
            {
                new MessageListItemViewModel
                {
                    ...
                    Message ="1. Web API Architecture\n2. Resources and URIs\n3. HTTP Methods\n4. HTTP Status Codes\n5. HTTP Content\n6. Content Negotiation\n7. Http Request and Response\n8. Parameter Binding, Model Binding, and Model Validation\n9. CRUD Operations\n10. Exception Handling",
                ...
                new MessageListItemViewModel
                {
                    ...
                    Initials = "SP",
                    Subject = "GGK -- ACS",
                    Message = "I want to share some exciting news with everyone. Effective January 31st GGK Tech will be a part of American CyberSystems, Inc (ACS), a premier provider of IT Consulting, Engineering Consulting, Healthcare, Talent, and Workforce Management Solutions to Fortune 500 companies across the globe. They are based in the United States with sizable presence around the world. GGK Tech will be a significant addition to the list of ACS brands and we will continue to function the same way we have been functioning over the last 14 years, except that we will be growing",
